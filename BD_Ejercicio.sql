...
CREATE TABLE Articulos(
    idArtiuclo SMALLINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Compras(
    ...
    idArtiuclo SMALLINT NOT NULL AUTO_INCREMENT,
    FOREIGN KEY (idCliente) REFERENCES Clientes (idCliente),
    FOREIGN KEY (idArtiuclo) REFERENCES Articulos (idArtiuclo)
);
